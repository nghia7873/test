...
function LightToggle() {
    if (light == 0) {
        ...
        jQuery("#light-status").html("เปิดไฟ");
        // if (expandPlayer == 0) {
        ...
        jQuery("#light-status").html("ปิดไฟ");
        light = 0;
    }
}
jQuery(document).ready(function () {
    jQuery("#btn-autonext").on("click", function () {
        return (
            pautonext
                ? (jQuery("#autonext-status").html("ปิด"), (pautonext = !1))
                : (jQuery("#autonext-status").html("เปิด"), (pautonext = !0)),
            !1
        );
    }),
        ...
        jQuery("#btn-toggle-error").on("click", function () {
            jQuery
                ...
                .done(function (data) {
                    fx.displayMessage(
                        "ข้อความของคุณถูกส่งไปแล้ว เราจะดำเนินการแก้ไขโดยเร็วที่สุด ขอบคุณมาก!"
                    );
                });
        ...
        jQuery("#btn-expand").on("click", function () {
            if (0 == resizePlayer) {
                ...
                jQuery("#sidebar").animate({
                    ...
                    fx.scrollTo("#watch-block", 1e3),
                    jQuery("#expand-status").html("ขยาย"),
                    (resizePlayer = !1);
            return !1;
        }),
...
function downloadFilm() {
    fx.displayMessage(
        "คลิกที่ไอคอนดาวน์โหลดในกรอบเครื่องเล่นภาพยนตร์เพื่อดาวน์โหลดภาพยนตร์เรื่องนี้"
    );
}
